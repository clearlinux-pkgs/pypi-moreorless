...
Source0  : https://files.pythonhosted.org/packages/8d/85/2e4999ac4a21ab3c5f31e2a48e0989a80be3afc512a7983e3253615983d4/moreorless-0.5.0.tar.gz
...
%prep
%setup -q -n moreorless-0.5.0
cd %{_builddir}/moreorless-0.5.0
pushd ..
cp -a moreorless-0.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746455699
